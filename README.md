...
* **Pipeline:** Alberga la pipeline de ejecución de control de calidad, filtrado y conteo. Esta carpeta tiene sus propias instrucciones en su archivo [README.md](./Pipeline/README.md).
